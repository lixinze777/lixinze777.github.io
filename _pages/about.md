...
My research interest includes long context, retrieval augmented generation (RAG), and agent memory. I have published papers at top international conferences ACL, EMNLP, and NeurIPS, with total <a href='https://scholar.google.com/citations?user=XdNw0cwAAAAJ'>Google Scholar citations <strong><span id='total_cit'>700+</span></strong></a>.


# 🔥 News
- *2026.08*: &nbsp;🎉🎉 Two papers accepted to EMNLP 2026 (Findings)!
...
# 📝 Publications
- [Skill-as-Pseudocode: Refactoring Skill Libraries to Pseudocode for LLM Agents](https://arxiv.org/abs/2605.27955), **Xinze Li**, Yuhang Zang, Yixin Cao, Aixin Sun. **EMNLP 2026 (Findings)**
- [EMemBench: Interactive Benchmarking of Episodic Memory for VLM Agents](https://arxiv.org/abs/2601.16690), **Xinze Li**, Zihao Zhu, Siyuan Liu, Yubo Ma, Yuhang Zang, Yixin Cao, Aixin Sun. **EMNLP 2026 (Findings)**
...
# 💻 Internships
- *2025.07 - now*, Research Intern, Shanghai AI Laboratory, China.
